        ...
        <Sidebarx>
          <main>
            <header className="flex justify-between items-center p-4 sticky top-0 bg-black z-50">
              ...
              <div className="absolute top-20 left-0 right-0 h-5 bg-gradient-to-b from-black to-transparent pointer-events-none" />
            </header>
            ...
            <section className="px-6 py-4 pb-25">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4">Songs you'll Enjoy!</h2>
                {loading ? (
