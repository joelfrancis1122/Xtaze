...
import { setCurrentTrack, setIsPlaying, setCurrentTime, setDuration } from "../../redux/audioSlice"; // Add setCurrentTime, setDuration
...
export default function ExplorePage() {
  ...
  const audioRef = useRef<HTMLAudioElement | null>(null); // Add audioRef
  ...
  useEffect(() => {
    ...
    const playAudio = async () => {
      ...
      try {
        ...
        dispatch(setIsPlaying(false)); // Reset playing state on error
      }
    };
